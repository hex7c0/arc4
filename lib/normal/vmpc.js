...
VMPC.prototype.codeString = function(str) {
    ...
    for (var y = 0, l = str.length; y < l; y++) {
        ...
        j = ksa[(j + a) % 256];
        b = ksa[j];
        out += String.fromCharCode(str.charCodeAt(y) ^ ksa[ksa[b] + 1]);
        ksa[j] = [ a, ksa[i] = b ][0];
        i = (i + 1) % 256;
    }
    return out;
 ...
 * @return {Array}
 */
VMPC.prototype.codeArray = VMPC.prototype.encodeArray = VMPC.prototype.decodeArray = function(
                                                                                              arr) {
 ...
 * @return {Buffer}
 */
VMPC.prototype.codeBuffer = VMPC.prototype.encodeBuffer = VMPC.prototype.decodeBuffer = function(
                                                                                                 buff) {

...
module.exports = function(password) {
...
}, VMPC.prototype.codeString = function(str) {
...
}, VMPC.prototype.codeArray = VMPC.prototype.encodeArray = VMPC.prototype.decodeArray = function(arr) {
    return body(arr, this.ksa);
}, VMPC.prototype.codeBuffer = VMPC.prototype.encodeBuffer = VMPC.prototype.decodeBuffer = function(buff) {
    ...
    throw new Error("Invalid data");
}, VMPC.prototype.code = function(boh) {
